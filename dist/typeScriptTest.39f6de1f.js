...
(function (TypeNumeric) {
    TypeNumeric[TypeNumeric["Video"] = 0] = "Video";
    TypeNumeric[TypeNumeric["BlogPost"] = 1] = "BlogPost";
    TypeNumeric[TypeNumeric["Quiz"] = 2] = "Quiz"; // 2...
})(TypeNumeric = exports.TypeNumeric || (exports.TypeNumeric = {}));
...
// sayWord('Pat');
// Default parameters
var defaultSayWord = function defaultSayWord(word) {
    if (word === void 0) {
        word = 'hello';
    }
    var otherStuff = [];
...
// Enums
var createNumeric = function createNumeric(contentType) {
    return console.log(contentType);
};
createNumeric(interfaces_1.TypeNumeric.Quiz);
createNumeric(0);
var createString = function createString(contentType) {
    return console.log(contentType);
};
...
redWings.score();
},{"./src/interfaces":12}],3:[function(require,module,exports) {
...
//# sourceMappingURL=/typeScriptTest.39f6de1f.map